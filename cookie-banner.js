(function(){
  ...
  function showBanner(){
    ...
    el.innerHTML = '' +
      '<div style="flex:1;min-width:160px;font-size:11.5px;line-height:1.35;color:#6b6058;"><b style="color:#261818;">🍪 Cookies</b> use hote hain site behtar chalane ke liye. <a href="/privacy" style="color:#8a3b32;text-decoration:underline;">Privacy</a></div>' +
