...
function bbExportBackup(){
  ...
  a.href=URL.createObjectURL(blob);a.download=`baatbanao-backup-${todayISO()}.json`;a.click();setTimeout(()=>URL.revokeObjectURL(a.href),2000);bbTrack('backup_export',{keys:Object.keys(data.data).length});showToast('Backup download ho gaya ✅');
}
